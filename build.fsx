...
let project = "FSharp.Data.JsonValidation"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Validate your JSON values using data structures. Inspired by [joi](https://github.com/hapijs/joi)."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Validate your JSON values using data structures. Inspired by [joi](https://github.com/hapijs/joi)."

// List of author names (for NuGet package)
let authors = [ "softwaredevelopment@matrixformedia.com" ]

// Tags for your project (for NuGet package)
let tags = "F# fsharp data json validation"

// File system information
let solutionFile  = "FSharp.Data.JsonValidation.sln"
...
let gitOwner = "MatrixSolutions"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "FSharp.Data.JsonValidation"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/MatrixSolutions"
